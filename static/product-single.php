    ...
    <div class="pw-body">
        <div class="pw-inner">
            ...
            <div class="pw-content">
                <div class="cover">
                    <div class="inner">
                        <img src="img/book_140.jpg" title="" />
                    </div>
                </div>
                <div class="info">
                ...
                <div class="desc">
                    <h4>Description</h4>
                    <p>For Dummies is an extensive series of instructional / reference books which are intended to present non-intimidating guides for readers new to the various topics covered.</p>
                </div>
            </div>
        </div>
    </div>
